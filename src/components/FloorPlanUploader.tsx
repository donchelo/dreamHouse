...
import { Upload, X, Map, Trash2, CheckCircle2, Layout } from 'lucide-react';
...
export default function FloorPlanUploader({ file, onFileChange }: FloorPlanUploaderProps) {
  ...
  return (
    <div className="space-y-4 p-5 sm:p-6" role="region" aria-labelledby="floor-plan-uploader-title">
      <div className="flex items-center gap-4">
        ...
        <div>
          <h3 id="floor-plan-uploader-title" className="text-lg font-semibold text-foreground flex items-center gap-2">
          ...
          <p className="text-sm text-muted-foreground mt-0.5">
            Sube tu propio plano de planta. La IA lo usará como base para generar el render 3D.
          </p>
        </div>
      </div>
