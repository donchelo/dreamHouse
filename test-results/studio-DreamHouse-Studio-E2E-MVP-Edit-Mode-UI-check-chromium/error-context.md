...
- Name: studio.spec.ts >> DreamHouse Studio E2E MVP >> Edit Mode: UI check
- Location: tests/e2e/studio.spec.ts:133:7
...
Locator: getByText('Sube la imagen a editar')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByText('Sube la imagen a editar')
    ...
    - generic [ref=e38]:
      ...
      - generic [ref=e54]:
        ...
        - generic [ref=e70]:
          ...
          - button "Editar Imagen con IA" [active] [ref=e81]:
            - img [ref=e82]
