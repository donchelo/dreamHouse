...
- Name: studio.spec.ts >> DreamHouse Studio E2E MVP >> Global Actions: Surprise Me and Reset
- Location: tests/e2e/studio.spec.ts:27:7
...
Locator: getByText('Se ha generado un diseño exterior aleatorio.')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByText('Se ha generado un diseño exterior aleatorio.')
  ...
  - main [ref=e37]:
    - generic [ref=e38]:
      ...
      - generic [ref=e42]:
        ...
        - button "Generar una combinación aleatoria de parámetros para inspiración" [active] [ref=e49]:
          - img [ref=e50]
      ...
      - generic [ref=e54]:
        ...
        - generic [ref=e70]:
          ...
          - button "Diseño Interior" [ref=e76]:
            - img [ref=e77]
